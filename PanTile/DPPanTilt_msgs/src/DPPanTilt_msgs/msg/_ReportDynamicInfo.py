"""autogenerated by genmsg_py from ReportDynamicInfo.msg. Do not edit."""
import roslib.message
import struct

import std_msgs.msg

class ReportDynamicInfo(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','bool','float32','float32','float32','float32']
