...
(cl:defmethod cl:initialize-instance :after ((m <GPS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple-msg:<GPS> is deprecated: use simple-msg:GPS instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple-msg:latitude-val is deprecated.  Use simple-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple-msg:longitude-val is deprecated.  Use simple-msg:longitude instead.")
  (longitude m))
